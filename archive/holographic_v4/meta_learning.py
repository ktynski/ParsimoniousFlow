...
from holographic_v4.constants import PHI, PHI_INV, PHI_INV_SQ, PHI_INV_CUBE, PHI_INV_FOUR, PHI_INV_SIX
...
def verified_retrieve(
    ...
    Args:
        ...
        agreement_threshold: Threshold for "high agreement" (default 0.8)
        noise_std: Standard deviation of perturbation noise (default 0.05)
